...
# Block 1
x = Conv2D(2048, (3, 3), activation='relu', padding='same', name='block1_conv1', kernel_initializer='random_normal')(input_layer)
x = Conv2D(4096, (11, 11), activation='relu', padding='same', name='block1_conv2', kernel_initializer='random_normal')(x)
